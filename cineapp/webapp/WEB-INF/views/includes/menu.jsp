...
<nav class="navbar navbar-inverse navbar-fixed-top">
	<div class="container">
		<div class="navbar-header">
			...
			<sec:authorize access="hasAnyAuthority('EDITOR')"><a class="navbar-brand" href="${urlRoot}admin/index">My CineSite | Editor</a></sec:authorize>
			
			<sec:authorize access="hasAnyAuthority('GERENTE')"><a class="navbar-brand" href="${urlRoot}admin/index">My CineSite | Gerente</a></sec:authorize>
		...
		<div id="navbar" class="navbar-collapse collapse">
			...
			<sec:authorize access="hasAnyAuthority('EDITOR')">
				...
				<li><a href="${urlLogin}logout">Cerrar Sesión</a></li>
			</sec:authorize>
