...
import net.brndnrg.app.service.IPerfilesService;
import net.brndnrg.app.service.IUsuariosService;
...
public class UsuariosController {
	...
	public String guardar(@ModelAttribute Usuario usuario, @RequestParam("perfil") String perfil) {
		...
		System.out.println("Perfil: ".concat(perfil));
		String tmpPass = encoder.encode(usuario.getPwd());
		usuario.setPwd(tmpPass);
